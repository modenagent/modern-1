...
class Test extends CI_Controller{
    ...
    function reports(){
        if(!$this->input->post()){
            ...
            $this->load->view("user/test/reports",$data);
            exit();
        }
        ...
        $html = $this->load->view("reports/".$reportLang."/".$_POST['presentation']."/index",$data,true);
        ...
        $pdfFileName = $report187->PropertyProfile->SiteAddress.'_'.uniqid().'.pdf';
