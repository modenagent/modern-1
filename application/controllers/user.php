...
class User extends CI_Controller
{
    ...
    public function download_invoice($invoiceNumber)
    {
        $userId = $this->session->userdata('userid');
        if ($userId) {
    ...
    public function is_subscribed($planId = null, $userId = null)
    {
        if ($userId == null) {
            $userId = $this->session->userdata('userid');
        }
    ...
    public function preview($reportType = '', $language = '', $page = 0)
    {
        if ($this->session->userdata('userid')) {
    ...
    public function show_pdf_preview($reportType = '', $language = '', $page = 0)
    {
        if ($this->session->userdata('userid')) {
            $is_enterprise_user = is_enterprise_user();
            if (!$is_enterprise_user) {
    ...
    public function customize($report = '', $page = '')
    {
        if ($this->session->userdata('userid')) {
            $is_enterprise_user = is_enterprise_user();
            if ($is_enterprise_user) {
