 ...
 * @version    $Id: Named.php 379 2013-02-11 11:27:25Z jan $
 */
...
class SetaPDF_Core_Document_Action_Launch extends SetaPDF_Core_Document_Action
{
    ...
    /**
     * Get the NewWindow flag specifying wheter to open the destination document in a new window
     *
     * @return null|boolean
     */
    ...
    /**
     * Set the NewWindow flag specifying wheter to open the destination document in a new window
     *
