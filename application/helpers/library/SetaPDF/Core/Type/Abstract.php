 ...
 * @version    $Id: Abstract.php 388 2013-02-14 11:17:42Z maximilian.kresse $
 */
 ...
 * @license    http://www.setasign.de/ Commercial
 */
abstract class SetaPDF_Core_Type_Abstract implements SplSubject
{
    /**
    ...
    /**
     * Impelementation of __sleep
     * 
     * We remove the observers from all elements because they will get
     * readded if they are waked up in an observed object.
     * 
     * @return array
     */
     ...
     * 
     * The observers has to be removed with the detach()-method.
     * Only if theres no observer left this method should really
     * release resources.
     * 
