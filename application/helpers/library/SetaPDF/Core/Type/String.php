 ...
 * @version    $Id: String.php 423 2013-04-12 10:39:33Z jan.slabon $
 */
 ...
 * @license    http://www.setasign.de/ Commercial
 */
class SetaPDF_Core_Type_String extends SetaPDF_Core_Type_Abstract
    implements SetaPDF_Core_Type_StringValue, SetaPDF_Core_Type_ScalarValue
{
    ...
    /**
     * Unescapes excaped sequences in a PDF string according to the PDF specification
     *
     * @param string $s
     * @return string
     */
