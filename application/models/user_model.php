...
class User_model extends Base_model
{
    ...
    public function getUserDetails($userId, $fields = [])
    {
        $columns = '*';
        if (!empty($fields)) {
            if (is_array($fields)) {
    ...
    public function getUserDetailsByPermission($userId, $fields = [])
    {
        $columns = '*';
        if (!empty($fields)) {
            if (is_array($fields)) {
    ...
    public function getUserDetailsByEmail($emailAddress, $fields = [])
    {
        $columns = '*';
        if (!empty($fields)) {
            if (is_array($fields)) {
