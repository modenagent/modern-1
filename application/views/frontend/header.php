            ...
            <header id="header" class="header tra-menu navbar-light">
                <div class="header-wrapper">
                    ...
                    <div class="wsmobileheader clearfix">
                        <span class="smllogo"><img src="<?php echo base_url(); ?>/assets/frontend/images/Logo_dark.jpeg" alt="mobile-logo"/></span>
                    ...
                    <div class="wsmainfull menu clearfix">
                        <div class="wsmainwp clearfix">
                            ...
                            <!-- HEADER LOGO -->
                            <div class="desktoplogo"><a href="#hero-4" class="logo-black"><img src="<?php echo base_url(); ?>/assets/frontend/images/Logo_dark.jpeg" alt="header-logo"></a></div>
                            <div class="desktoplogo"><a href="#hero-4" class="logo-white"><img src="<?php echo base_url(); ?>/assets/frontend/images/Logo_light.jpeg" alt="header-logo"></a></div>
