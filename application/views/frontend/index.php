                            ...
                            <div class="txt-block left-column wow fadeInLeft">
                                ...
                                <!--    <h5 class="h5-lg">Multiplatform. Always Synced</h5>-->
                                    ...
                                    <ul class="simple-list">
                                        ...
                                        <li class="list-item">
                                            <p class="p-lg">You can save your specific theme and theme color so you dont have to worry about it everytime.
                                            </p>
                                        </li>
                        ...
                        <div class="row row-cols-1 row-cols-md-3">
                            ...
                            <div class="col">
                                <div class="pricing-2-table bg-white mb-40 wow fadeInUp">   
                                    ...
                                    <!-- Plan Features  -->
                                    <ul class="features">
                                        <li><p class="p-md">For agent that is looking to maximize their business opportunities.</p></li>
                                    </ul>
                            ...
                            <div class="col">
                                <div class="pricing-2-table bg-white mb-40 wow fadeInUp">
                                    ...
                                    <!-- Pricing Plan Button -->
                                    <a href="#" class="btn btn-sm btn-tra-grey tra-skyblue-hover">Contact Us</a>
                                    ...
                                    <table class="table text-center">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 22%;">Agent Build</th>
                                                <th style="width: 22%;">Agent Monthly</th>
                                                <th style="width: 22%;">Brokerage</th>
                                            </tr>
                                        </thead>
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-lg-7 col-lg-7">
                                <div class="cta-11-txt">
                                    ...
                                    <!-- Button -->
                                    <a href="#" class="btn btn-orange-red tra-orange-red-hover">Book Demo Now</a>
