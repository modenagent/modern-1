...
<!--						<img src="<?php echo base_url("assets/images-2/logo.png"); ?>"/>-->
							...
							<tr>
								...
								<td valign="top" width="150" align="center" style="padding-left:20px" >
									<table width="150" border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
										<tr>
											<td width="150" bgcolor="#f15d3e"align="center" style="border-top-left-radius: 3px; border-top-right-radius: 3px; border-bottom-right-radius: 3px; border-bottom-left-radius: 3px; background:none; border: 1px solid #000;">												
												<table width="150" border="0" cellpadding="0" cellspacing="0" align="center">
													...
													<tr>
														<td valign="top" width="100%" align="center" style="text-align: center; font-size: 14px; font-family: Montserrat; color: rgb(0,0,0); font-weight: bold; line-height: 18px; text-transform: uppercase;" >
															<span style="font-family: Montserrat; font-weight: normal;"><a href="<?php echo site_url(); ?>" style="text-decoration: none; color: rgb(0,0,0);">ACCOUNT LOGIN</a></span>
														</td>
													</tr>
													<tr>
				...
				<tr>
					<td width="600" bgcolor="#000" height="60" valign="middle" align="center" style="text-align:left; border-top-right-radius: 3px; border-top-left-radius: 3px; background-color: rgb(0,0,0);">
							...
							<tr>
								<td valign="top" width="300" style="text-align: left;     font-family: Montserrat; font-size: 14px; color: rgb(34, 34, 34); line-height: 24px; font-weight: normal;">
									<span style="font-family: Montserrat font-weight: normal;">
										...
										<br>
										<span style="font-family: Montserrat font-weight: normal;">
											<span style="color: rgb(85, 201, 224);"><?php echo $lp_details['property_address']; ?></span>
										</span>
									</span>
								</td>
								<td width="250">
				...
				<tr>
					<td width="600" border="0" height="60" cellpadding="0" cellspacing="0" align="center" bgcolor="#000"style="border-top-left-radius: 3px; border-top-right-radius: 3px; border-bottom-right-radius: 3px; border-bottom-left-radius: 3px; background-color: rgb(0,0,0);     font-family: Montserrat; font-size: 13px; color: rgb(255, 255, 255);">
						<span style="font-family: Montserrat font-weight: normal;">
