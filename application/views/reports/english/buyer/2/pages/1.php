<page class="p-0">
    ...
    <div class="d-flex no_gutter">
        <div class="col-50">            
            <img src="<?php echo base_url("assets/reports/english/buyer/2/images/shutterstock-472326997.jpg"); ?>" alt="24ad-Traditional" class="img-fluid cat_img">
            <ul class="address_offer">
                <li>1234 Main Street,<br> City, State 00000</li>
                <li>Oﬀered for<br> $0,000,000</li>
            </ul>
    ...
    <div class="mid-img pt-0">
        <img src="<?php echo base_url("assets/reports/english/buyer/2/images/hero.png"); ?>" alt="Hero img" class="hero_img">
    </div>
