<page>
    <h1 class="small_big"><span>Loan</span> Checklist</h1>
    <p class="mt-40">
    ...
    <div class="d-flex mt-50">
        <div class="col-50">
            <div class="check_box">
                ...
                <p class="uppercase">Proof of Income</p>
                <p>
            ...
            <div class="check_box">
                ...
                <p class="uppercase">What You Need to Know</p>
                <p>
        ...
        <div class="col-50">
            <div class="check_box">
                ...
                <p class="uppercase">Proof of Assets</p>
                <p>
            ...
            <div class="check_box">
                ...
                <p class="uppercase">Proof of Current Employment</p>
                <p>
