<page>
    ...
    <div class="d-flex mt-50 gutter-30">    
        ...
        <div class="col-50">
            <img src="<?php echo base_url("assets/reports/english/buyer/2/images/shutterstock-1395528875.jpg"); ?>" alt="img4" class="img-fluid w100">
    ...
    <div class="neighborhood_stats">
        <ul class="stats">
            <li>
                <img src="<?php echo base_url("assets/reports/english/buyer/2/images/img7.png"); ?>" alt="Avg. Sale Price">
                Avg. Sale Price<br>$<?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianValue; ?>
            </li>
            <li>
                <img src="<?php echo base_url("assets/reports/english/buyer/2/images/img8.png"); ?>" alt="Avg. Sqft">
                Avg. Sqft<br><?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianLivingArea; ?>
            </li>
            <li>
                <img src="<?php echo base_url("assets/reports/english/buyer/2/images/img9.png"); ?>" alt="Avg. Beds">
                Avg. Beds<br><?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianNumBeds; ?> Beds
            </li>
            <li>
                <img src="<?php echo base_url("assets/reports/english/buyer/2/images/img10.png"); ?>" alt="Avg. Baths">
