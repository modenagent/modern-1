<page class="pdf7 buyerpdf7">
    ...
    <div class="d-flex">    
        <div class="col-12">
            <h4 class="table_title no_line mt-50">Elementary</h4>
            <table>
                <tr>
            ...
            <h4 class="table_title no_line mt-30">Junior Highschool</h4>
            <table>
                <tr>
            ...
            <h4 class="table_title no_line mt-30">High School</h4>
            <table>
                <tr>
            ...
            <h4 class="table_title no_line mt-30">Private School</h4>
            <table>
                <tr>
