<page class="buyerpdf10">
    ...
    <div class="d-flex row-30">
        <div class="col-50">
            ...
            <h4 class="table_title">Property Tax Due Dates</h4>
            <p>
        ...
        <div class="col-50">
            <div class="position-relative mt-10">
                <div class="monthly_installation">
                    ...
                    <!-- <img src="<?php echo base_url().'assets/reports/english/buyer/3/images/img22.png'; ?>" alt=""> -->
                </div>
            ...
            <div class="position-relative mt-20">
                <div class="monthly_installation">
                    ...
                    <!-- <img src="<?php echo base_url().'assets/reports/english/buyer/3/images/img23.png';?>" alt=""> -->
                </div>
                <div class="installment_text">
                    <p>
