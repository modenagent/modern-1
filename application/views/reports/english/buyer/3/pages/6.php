<page class="buyerpdf6">
    ...
    <div class="d-flex row-30">
        <div class="col-50">
            <img src="<?php echo base_url().'assets/reports/english/buyer/3/images/img4.png'; ?>" alt="img4" class="img-fluid w100">
    ...
    <div class="neighborhood_stats">
        <ul class="stats">
            <li>
                <img src="<?php echo base_url().'assets/reports/english/buyer/3/images/img7.png';?>" alt="img7">
                Avg. Sale Price<br>$<?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianValue; ?>
            </li>
            <li>
                <img src="<?php echo base_url().'assets/reports/english/buyer/3/images/img8.png';?>" alt="img8">
                Avg. Sqft<br><?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianLivingArea; ?>
            </li>
            <li>
                <img src="<?php echo base_url().'assets/reports/english/buyer/3/images/img9.png';?>" alt="img9">
                Avg. Beds<br><?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianNumBeds; ?> Beds
            </li>
            <li>
                <img src="<?php echo base_url().'assets/reports/english/buyer/3/images/img10.pn';?>g" alt="img10">
