...
.Squarearea p:before {
    ...
    $this->load->view('reports/english/buyer/pages/2');
    ...
    $this->load->view('reports/english/buyer/pages/6_b');
    $this->load->view('reports/english/buyer/pages/7');
    $this->load->view('reports/english/buyer/pages/8');
    $this->load->view('reports/english/buyer/pages/6_c');
    $this->load->view('reports/english/buyer/pages/6_d');
    $this->load->view('reports/english/buyer/pages/11');
    $this->load->view('reports/english/buyer/pages/9');
    $this->load->view('reports/english/buyer/pages/10');
    
    $this->load->view('reports/english/buyer/pages/12');
    $this->load->view('reports/english/buyer/pages/13');
    $this->load->view('reports/english/buyer/pages/14');
    $this->load->view('reports/english/buyer/pages/15');
    $this->load->view('reports/english/buyer/pages/16');
