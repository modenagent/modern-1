			...
			<div class="two-grid-wrapper">
				<div class="col-xs-6">
					<div class="left-grid">
						<div class="text-block-condensed">
							<h2>PRINCIPAL & INTEREST :<span> $1,603</span></h2>
							<p>
						...
						<div class="text-block-condensed">
							...
							<p>
                                                            ...
                                                            to pay your homeowner&rsquo;s insurance this way.
							</p>
						</div>
						<div class="text-block-condensed">
							<h2>Taxes : <span> $364</span></h2>
							<p>
				...
				<div class="col-xs-6">
					<div class="right-grid">
						<img width="100%" class="img-responsive" src="<?php echo base_url("assets/images/pg9-pit.png")?>" alt="">
                                                <div class="pg9-fixprice">Sample Loan: 30-year fixed, 4.54% APR</div><!-- .pg9-fixprice -->
                                                <div class="grph-prx"><img width="100%" class="img-responsive"  src="<?php echo base_url("assets/images/pg9-prices.png")?>" style="background-color:<?php echo $theme ?>;" alt="" width="325"/></div>
					</div>
				</div>
