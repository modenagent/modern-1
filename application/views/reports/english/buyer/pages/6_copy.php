<div class="container">
	<div class="section page6">
			...
			<img width="100%" class="img-responsive" src="<?php echo base_url("assets/reports/english/buyer/images/6/bg_1.jpg")?>" alt="">
			...
			<div class="page-content">
					...
					<div class="insights">
						<div class="col-xs-6">
							<div class="left-insight">
								<img  class="img-responsive" src="<?php echo base_url("assets/reports/english/buyer/images/6/gender.png")?>" alt="">
				...
				<ul class="features">
					<li>
                                            <img  class="img-responsive" src="<?php echo base_url("assets/reports/english/buyer/images/6/home.png")?>" alt="">
						<p>Avg. Sale Price <br > $<?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianValue; ?></p>
					</li>
					<li>
						<img  class="img-responsive" src="<?php echo base_url("assets/reports/english/buyer/images/6/sqr_feet.png")?>" alt="">
						<p>Avg. Sqft <br >  <?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianLivingArea; ?></p>
					</li>
					<li>
						<img  class="img-responsive" src="<?php echo base_url("assets/reports/english/buyer/images/6/bed.png")?>" alt="">
						<p>Avg. Beds <br > <?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianNumBeds; ?> Beds</p>
					</li>
					<li>
						<img  class="img-responsive" src="<?php echo base_url("assets/reports/english/buyer/images/6/cup.png")?>" alt="">
