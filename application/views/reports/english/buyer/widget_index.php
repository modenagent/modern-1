...
<?php
    ...
    {
        $this->load->view('reports/english/buyer/widget_pages/9');
    }
    if(in_array('10', $pdfPages))
    {
        $this->load->view('reports/english/buyer/widget_pages/10');
    }
    if(in_array('11', $pdfPages))
    {
        $this->load->view('reports/english/buyer/widget_pages/11');
    }
    if(in_array('12', $pdfPages))
    {
        $this->load->view('reports/english/buyer/widget_pages/12');
    }
    if(in_array('13', $pdfPages))
    {
        $this->load->view('reports/english/buyer/widget_pages/13');
    }
