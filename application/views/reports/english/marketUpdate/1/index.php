...
<html>
    <head>
        <title>Market Update Report</title>
    ...
    <body>
        ...
        <?php
            $availableCompareAble = count($areaSalesAnalysis['comparable']);
            ...
            if(count($areaSalesAnalysis['comparable'])>0):
                $avaiProperty = 0; 
                ...
                $this->load->view('reports/english/marketUpdate/1/pages/1',$dataForReport);
            else:
