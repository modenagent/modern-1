<div class="container">
	<div class="section page5">
		...
		<header>
			<h2 class="underline title-bold">Princing Correctly</h2>
        ...
        <div class="col-sm-12">
         ...
         <img class="img-responsive" src="assets/images/5/Princing.png" alt=""/>
    ...
    <div class="row">
     ...
     <h4 class="home">
       ...
       <p class="valuable2"> 
        ...
        Overpriced properties will most certainly <br> need to do atleast 1 price reduction to <br> 
     ...
     <div class="col-sm-6">
      ...
      <h4 class="home"> 4. Stigma Developed </h4>   
