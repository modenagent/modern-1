...
<header class="page-16-header" style="background-image: url(<?php echo base_url('assets/reports/english/marketUpdate/assets/images/header-2021.jpg');?>);">
    <h2 class="title-center heading-market">Registry Report</h2>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="article-1 gray-color">
                ...
                <p style="text-transform: none;"><a href="<?=base_url("registry/guest/{$unique_key}");?>"> <?=base_url("registry/guest/{$unique_key}");?></a></p>
