...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url("assets/reports/english/registry/3/style.css"); ?>">
...
<body>
    <page>
        ...
        <img src="<?php echo base_url("assets/reports/english/registry/3/img/flare.png"); ?>" alt="flare" class="flare_img">
    </page>
</body>
</html>