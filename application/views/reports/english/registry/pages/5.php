...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url("assets/reports/english/registry/5/style.css"); ?>">
...
<body>
    <page>
        ...
        <div class="qr_bg">
            <?php
            $image = base_url("user/generate_qr_code/$unique_key/6/".urlencode(json_encode([243,36,108]))."/".urlencode(json_encode([255,255,255])));
            ?>
        ...
        <img src="<?php echo base_url("assets/reports/english/registry/5/img/flare.png"); ?>" alt="flare" class="flare_img">
    </page>
</body>
</html>