    ...
    <style type="text/css">
        ...
        .pdf6 {
            background: -webkit-gradient(linear, left top, left bottom, from(rgba(
                            ...
                            <?php echo "$r,$g,$b" ?>
                            , 0.801)));
            background: -o-linear-gradient(rgba(
                        <?php echo "$r,$g,$b" ?>
                        , 0.801), rgba(
                        <?php echo "$r,$g,$b" ?>
                        , 0.801));
        ...
        .we_reach:before {
            background: -webkit-gradient(linear, left bottom, left top, from(rgba(0, 0, 0, 1)), color-stop(0.65, rgba(
                            <?php echo "$r,$g,$b" ?>
                            , 0.81)));
            background: -o-linear-gradient(bottom, rgba(0, 0, 0, 1) 0%, rgba(
                        <?php echo "$r,$g,$b" ?>
                        , 0.81) 0.65);
            background: linear-gradient(0deg, rgba(0, 0, 0, 1) 0%, rgba(
                        <?php echo "$r,$g,$b" ?>
                        , 0.81) 0.65);
        }
