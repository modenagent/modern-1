...
.page4-grid > .page4-col-6:last-child .properties{
    margin-left: 10px;
}
...
?>
                    ...
                    <div class="properties">Brief Legal Description:<br>
                    <?php echo isset($property->PropertyProfile->LegalDescriptionInfo->LegalBriefDescription) && !empty($property->PropertyProfile->LegalDescriptionInfo->LegalBriefDescription) ? $property->PropertyProfile->LegalDescriptionInfo->LegalBriefDescription : '-'; ?>
                    </div>
                </div>
                <div class="page4-col-6">
            ...
            <div>
                <div class="properties">
                    <div class="page4-grid">
                        <div class="page4-col-6">Assessed Value: <?php echo isset($property->PropertyProfile->AssessmentTaxInfo->AssessedValue) && !empty($property->PropertyProfile->AssessmentTaxInfo->AssessedValue) ? '$' . $property->PropertyProfile->AssessmentTaxInfo->AssessedValue : '-'; ?></div>
                        <div class="page4-col-6">Tax Amount: <?php echo isset($property->PropertyProfile->AssessmentTaxInfo->TaxAmount) && !empty($property->PropertyProfile->AssessmentTaxInfo->TaxAmount) ? '$' . $property->PropertyProfile->AssessmentTaxInfo->TaxAmount : '-'; ?></div>
                    </div>
                </div>
                <div class="properties">
                    <div class="page4-grid">
                        <div class="page4-col-6">Land Value: <?php echo isset($property->PropertyProfile->AssessmentTaxInfo->LandValue) && !empty($property->PropertyProfile->AssessmentTaxInfo->LandValue) ? '$' . $property->PropertyProfile->AssessmentTaxInfo->LandValue : '-'; ?></div>
                        <div class="page4-col-6">Tax Status: <?php echo isset($property->PropertyProfile->AssessmentTaxInfo->TaxStatus) && !empty($property->PropertyProfile->AssessmentTaxInfo->TaxStatus) ? $property->PropertyProfile->AssessmentTaxInfo->TaxStatus : '-'; ?></div>
                    </div>
                </div>
                <div class="properties">
                    <div class="page4-grid">
                        <div class="page4-col-6">Improvement Value: <?php echo isset($property->PropertyProfile->AssessmentTaxInfo->ImprovementValue) && !empty($property->PropertyProfile->AssessmentTaxInfo->ImprovementValue) ? $property->PropertyProfile->AssessmentTaxInfo->ImprovementValue : '-'; ?></div>
                        <div class="page4-col-6">Tax Rate Area: <?php echo isset($property->PropertyProfile->AssessmentTaxInfo->TaxRateArea) && !empty($property->PropertyProfile->AssessmentTaxInfo->TaxRateArea) ? $property->PropertyProfile->AssessmentTaxInfo->TaxRateArea . '%' : '-'; ?></div>
                    </div>
                </div>
                <div class="properties">
                    <div class="page4-grid">
                        <div class="page4-col-6">% Improvement: <?php echo isset($property->PropertyProfile->AssessmentTaxInfo->PercentImproved) && !empty($property->PropertyProfile->AssessmentTaxInfo->PercentImproved) ? $property->PropertyProfile->AssessmentTaxInfo->PercentImproved . '%' : '-'; ?></div>
                        <div class="page4-col-6">Tax Year: <?php echo isset($property->PropertyProfile->AssessmentTaxInfo->TaxYear) && !empty($property->PropertyProfile->AssessmentTaxInfo->TaxYear) ? $property->PropertyProfile->AssessmentTaxInfo->TaxYear : '-'; ?></div>
                    </div>
                </div>
            </div>
        </div>
