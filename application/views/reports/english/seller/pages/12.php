<div class="container">
    <page class="pdf12">
        ...
        <img src="<?php echo base_url().'assets/reports/english/seller/images/12/pricing.png'; ?>" alt="pricing" class="img-fluid mt-60 d-block">
        <div class="d-flex mt-60 steps">
            <div class="col-50">
                <?php
                ...
                <?php
                    $para_1_content = isset($report_content_data['paragraph_1_content']['value']) && !empty($report_content_data['paragraph_1_content']['value']) ? $report_content_data['paragraph_1_content']['value'] : 'Properties that are over priced tend to stay on the market significantly longer than those that are priced to sell.';
                ?>
                ...
                <?php
                    $para_2_content = isset($report_content_data['paragraph_2_content']['value']) && !empty($report_content_data['paragraph_2_content']['value']) ? $report_content_data['paragraph_2_content']['value'] : 'Overpriced properties will most certainly need to do at least 1 price reduction to regenerate interest in your property.';
                ?>
            ...
            <div class="col-50">
                ...
                <?php
                    $para_3_content = isset($report_content_data['paragraph_3_content']['value']) && !empty($report_content_data['paragraph_3_content']['value']) ? $report_content_data['paragraph_3_content']['value'] : 'Time lost in waiting for an offer can be time spent accepting offers, conducting inspections & opening escrow.';
                ?>
                ...
                <?php
                    $para_4_content = isset($report_content_data['paragraph_4_content']['value']) && !empty($report_content_data['paragraph_4_content']['value']) ? $report_content_data['paragraph_4_content']['value'] : 'As buyers see the property advertised over and over again, they will start wondering if there’s something wrong with it.';
                ?>
