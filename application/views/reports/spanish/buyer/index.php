...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/reports/spanish/buyer/css/bootstrap.min.css") ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/reports/spanish/buyer/css/main.css") ?>">
</head>
...
.Squarearea p:before {
    ...
    if($partner && count($partner)>1) {
        $this->load->view('reports/english/spanish/pages/1');
        $this->load->view('reports/english/spanish/pages/1_multiagent');
    } else if($partner && count($partner)==1) {
        $this->load->view('reports/spanish/buyer/pages/1_agent');
    } else {
    ...
    $this->load->view('reports/spanish/buyer/pages/5');
    $this->load->view('reports/spanish/buyer/pages/6',$neighbor);
    $this->load->view('reports/spanish/buyer/pages/6_a',array("school"=>$school));
    $this->load->view('reports/spanish/buyer/pages/6_b');
    $this->load->view('reports/spanish/buyer/pages/7');
    $this->load->view('reports/spanish/buyer/pages/8');
    $this->load->view('reports/spanish/buyer/pages/6_c');
    $this->load->view('reports/spanish/buyer/pages/6_d');
    $this->load->view('reports/spanish/buyer/pages/11');
    $this->load->view('reports/spanish/buyer/pages/9');
    $this->load->view('reports/spanish/buyer/pages/10');
    
    $this->load->view('reports/spanish/buyer/pages/12');
    $this->load->view('reports/spanish/buyer/pages/13');
    $this->load->view('reports/spanish/buyer/pages/14');
    $this->load->view('reports/spanish/buyer/pages/15');
    $this->load->view('reports/spanish/buyer/pages/16');
