			...
			<div class="col-xs-6">
			   <div class="agreement-col seller">
				   ...
				   <div class="row">
						<div class="header">
							<div class="col-xs-2">
                                                            <img width="100%" src="<?php echo base_url("assets/reports/spanish/buyer/images/10/seller_home.png"); ?>">
							</div>
							<div class="col-xs-10">
...
and other recordable document(s)</li>
	...
	<img src="<?php echo base_url("assets/reports/spanish/buyer/images/10/bg2.jpg") ?>" class="img-responsive padding-top-small" width="100%" alt="">
