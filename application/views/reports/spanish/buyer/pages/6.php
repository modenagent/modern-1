<div class="container">
	<div class="section page6">
			...
			<img width="100%" class="img-responsive" src="<?php echo base_url("assets/reports/spanish/buyer/images/6/bg3.jpg")?>" alt="">
					...
					<div class="insights">
						<div class="col-xs-6">
							<div class="left-insight">
								<img  class="img-responsive theme-bg" src="<?php echo base_url("assets/reports/spanish/buyer/images/6/gender.png")?>" alt="">
								...
								<div class="text-content">
										...
										<p>
											The figure to the right represents the average household income within your perspective neighborhood. This information is gathered from the household census that is taken every 10 years.
                                                                                ...
                                                                                <p style=" color: <?php echo $theme ?>;" >$<?php echo $household_income ?></p>
								</div>
							</div>   <!-- .right-insight  -->
						</div> <!-- .col-xs-6 -->
					</div> <!-- .insights -->
				...
				<ul class="features">
					<li>
                                            <img  class="img-responsive" style="padding-left:35px;" src="<?php echo base_url("assets/reports/spanish/buyer/images/6/home.png")?>" alt="">
						<p>Avg. Sale Price <br > $<?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianValue; ?></p>
					</li>
					<li>
						<img  class="img-responsive" style="padding-left:35px;" src="<?php echo base_url("assets/reports/spanish/buyer/images/6/sqr_feet.png")?>" alt="">
						<p>Avg. Sqft <br >  <?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianLivingArea; ?></p>
					</li>
					<li>
						<img  class="img-responsive" style="padding-left:30px;" src="<?php echo base_url("assets/reports/spanish/buyer/images/6/bed.png")?>" alt="">
						<p>Avg. Beds <br > <?php echo (string)$property->ComparableSalesReport->AreaSalesAnalysisInfo->MedianNumBeds; ?> Beds</p>
					</li>
					<li>
						<img  class="img-responsive"  style="padding-left:30px;" src="<?php echo base_url("assets/reports/spanish/buyer/images/6/cup.png")?>" alt="">
