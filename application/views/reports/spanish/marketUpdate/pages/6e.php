<div class="container">
	<div class="section page7">
		...
		<header>
			<h2 class="underline title-bold"> Social Media & Networking </h2>
			...
			<div class="two-grid-wrapper">
				<div class="col-xs-6">
					<div class="left-grid">
						...
						<div class="text-block-condensed">
							<h2>Broker 2 Broker Networking </h2>
							<p>
								Brokers are consistently networking with other brokers find the homes that matches their clients criteria. We will network with all surrounding brokers and realtors to see if your properties a match for one of their
							</p>
						</div>
				...
				<div class="col-xs-6">
					<div class="right-grid">
						<img width="100%" class="img-responsive" src="assets/images/6e/6e.jpg" alt="">
					</div>
				</div>
