...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url("assets/reports/english/registry/style.css"); ?>">
...
<body>
    <page>
        ...
        <!-- <img src="<?php echo base_url("assets/reports/english/registry/img/QR.png"); ?>" alt="QR Code"> -->
        <?php
