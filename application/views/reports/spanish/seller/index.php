...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/reports/spanish/seller/css/bootstrap.min.css") ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/reports/spanish/seller/css/main.css") ?>">
</head>
...
<style type="text/css">
 ...
 <style type="text/css" media="print">
    ...
    if($partner && count($partner)>1) {
        ...
        $this->load->view('reports/spanish/seller/pages/1_agent');
    } else {
        $this->load->view('reports/spanish/seller/pages/1');
    }
    $this->load->view('reports/spanish/seller/pages/2');
    $this->load->view('reports/spanish/seller/pages/4');
    $this->load->view('reports/spanish/seller/pages/5');
    $this->load->view('reports/spanish/seller/pages/5b');
    $this->load->view('reports/spanish/seller/pages/5c');
    $this->load->view('reports/spanish/seller/pages/5e',$rangeOfSales);
    $this->load->view('reports/spanish/seller/pages/5h', $customization_pages_data['9']);
    $this->load->view('reports/spanish/seller/pages/5f', $customization_pages_data['10']);
    $this->load->view('reports/spanish/seller/pages/5g', $customization_pages_data['11']);
    
    $this->load->view('reports/spanish/seller/pages/5k', $customization_pages_data['12']);
    $this->load->view('reports/spanish/seller/pages/6');
    $this->load->view('reports/spanish/seller/pages/6c', $customization_pages_data['13']);
    $this->load->view('reports/spanish/seller/pages/6d', $customization_pages_data['14']);
    $this->load->view('reports/spanish/seller/pages/6e', $customization_pages_data['15']);
    $this->load->view('reports/spanish/seller/pages/6f', $customization_pages_data['16']);
    $this->load->view('reports/spanish/seller/pages/6g', $customization_pages_data['17']);
    $this->load->view('reports/spanish/seller/pages/9d', $customization_pages_data['18']);
    $this->load->view('reports/spanish/seller/pages/11b', $customization_pages_data['19']);
    $this->load->view('reports/spanish/seller/pages/15');
