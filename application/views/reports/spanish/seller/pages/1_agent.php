<style>
    .section .footer .footer-inner .left-footer p{
        font-size:14px;
        margin-left: 10px;
    }
    .section .footer .footer-inner .left-footer h4 {
        margin-left: 10px;
    }
    .company-img{
        padding-top:10px;
...
<div class="container">
	<div class="section">
		<div class="body">
			<img width="100%" class="img-responsive" src="<?php echo base_url("assets/reports/spanish/seller/images/1/1_b3_agent.jpg") ?>">	
			<div class="section-content">
				<p>Informe de los vendedores</p>
