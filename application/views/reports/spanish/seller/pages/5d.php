<div class="container">
    <div class="section page5">
        ...
        <header>
                <h2 class="underline title-bold">VENTAS COMPARABLES</h2>
                <p> Propiedades que se han vendido recientemente.</p>
        </header>
                ...
                <?php endif; ?>
                    <div class="col-xs-6">
                        ...
                        <table class="table table-top-sales">
                            <tbody>
                                <tr class="gray-color">
                                        <td style="padding-right: 80px;">Vendido el</td>
                                        <td> Dist. </td>
                                        <td> Pies. </td>
                                        <td> $/pie </td>
                                </tr>
                                ...
                                <tr class="gray-color">
                                        <td style="padding-right: 80px;">Hab/Baño</td>
                                        <td> YAño de Constr </td>
                                        <td> Área de Lote </td>
                                        <td> Piscina </td>
                                </tr>
