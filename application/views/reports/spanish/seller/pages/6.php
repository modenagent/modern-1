<div class="containers" style="height:0;width:0; padding:0;margin:0;">
	<div class="section page6">
			...
			<img width="100%" class="img-responsive" src="<?php echo base_url("assets/reports/spanish/seller/images/6/bg.jpg")?>" alt="">
					...
					<div class="insights">
						<div class="col-xs-6">
							<div class="left-insight">
								<img  class="img-responsive" src="<?php echo base_url("assets/reports/spanish/seller/images/6/gender.png")?>" alt="">
