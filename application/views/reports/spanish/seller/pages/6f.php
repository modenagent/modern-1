    ...
    <div class="row">
     ...
     <div class="col-sm-12">
      ...
      <table class="table">
        <tbody>
          <tr class="gray-color">
            <td><p class="homea"> Casa A</p> </td>
            <td><p class="homea2"> Casa B </p></td>
            <td><p class="homea2"> Jane & Joe </p></td>
            <td><p class="homea2"> Casa D </p></td>
            <td><p class="homea2"> Casa E </p></td>
      ...
      <table class="table">
        <tbody>
          <tr class="gray-color">
            <td><p class="homea"> Casa A</p> </td>
            <td><p class="homea"> Casa B </p></td>
            <td><p class="homea"> Jane & Joe </p></td>
            <td><p class="homea"> Casa D </p></td>
            <td><p class="homea"> Casa E </p></td>
            <td><p class="homea"> Casa F </p></td>
          ...
          <tr>
            ...
            <td><p class="homea">Reducida <br> & y Vendida   </p></td>
            <td><p class="homea"> </p></td>
            <td><p class="homea">Vendida </p></td>
            <td><p class="homea">Vendida  </p></td>
            <td><p class="homea">Recién Colocada </p></td>
  ...
  <div class="col-sm-12">
   ...
   <div class="home-box">
    ...
    <div class="home-pc">
     ...
     <img class="img-responsive theme-bg" src="<?php echo base_url("assets/reports/spanish/seller/images/6f/home.png")?>" alt=""/>
