<page class="property_list">
    ...
    <div class="property_list_title">YOU NEED TO LIST YOUR PROPERT</div>
    <div class="listing_steps">
        <ol class="ol_num">
            ...
            <li data-value="11">Information on special assessments (if applicable) </li>
            <li data-value="12">Homeowners / Condominium associations
                <ul>
                    <li>Amount</li>
                    <li>Company</li>
                    <li>Address</li>
