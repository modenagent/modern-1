<page class="pdf10">
    <h1 class="small_big"><span>Property</span> Taxes</h1>
    <div class="d-flex gutter-30 mt-50">
        <div class="col-50">
            <h4 class="table_title no_line">IMPOUND ACCOUNT VS. DIRECT</h4>
            <p class="small_text">
            ...
            <h4 class="table_title no_line">PROPERTY TAX DUE DATES</h4>
            <p class="small_text">
            ...
            <p class="small_text">
                **Penalties for delinquency are 10% on date
                of delinquency, plus $10.00 for delinquent 2nd
                installment. Thereafter, 1.5% per month of original
                tax amount until paid.
            </p>
            <p class="small_text">
                Property may be sold at public auction after 5 years
                of delinquency
            </p>
        </div>
        <div class="col-50">
            <div class="position-relative mt-10">
                <div class="monthly_installation">
                    <img src="<?php echo base_url("assets/reports/widget/$report_dir_name/$presentation_type/images/img1.png"); ?>" alt="1st Installment">
                </div>
                <div class="installment_text">
                    ...
                    <p class="mt-40">
                        Feb 01: 2nd Installment Due
                    </p>
                    <p class="negative25">
                        Feb 15: Last day to file for
                        Homeowner’s exemption at 100%.
                        (File by Dec. 10 fpr 80% exemption)
                    </p>
                    <p class="mt-80">
            ...
            <div class="position-relative mt-20">
                <div class="monthly_installation">
                    <img src="<?php echo base_url("assets/reports/widget/$report_dir_name/$presentation_type/images/img2.png"); ?>" alt="2nd Installment">
                </div>
                <div class="installment_text">
                    <p>
                        Jul 01: Beginning of Fiscal Tax Year
                    </p>
                    <p class="mt-170 ">
                        Tax Bills Mailed Last Week of October
                    </p>
                    <p class="negative25">
                        Nov 01: 1st Installment Due
                    </p>
                    <p class="mt-80">
                        Dec 10: 1st Installment Delinquent
                        Last day to file for Homeowner’s
                        Exemption at 80%
                    </p>
                </div>
            </div>
