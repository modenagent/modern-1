                ...
                <div class="d-flex">
                    ...
                    <div class="col-40">
                        <ul class="list-inline">
                            <?php
if (empty($cma_url)):
    $cma_url = $_ENV['APP_URL'] . "cma";
endif;
$cma_url_display = preg_replace("(^https?://)", "", $cma_url);
?>
                            <li class="mb-2"><a href="<?=$_ENV['APP_URL'] . 'cma'?>"><img src="https://i.ibb.co/5KWxJxL/world.png" alt="WWW">
                                    <?php echo $cma_url_display; ?></a></li>
                            <li><a href="<?=$_ENV['APP_URL'] . 'cma'?>"><img src="https://i.ibb.co/jWYqWyd/keyboard.png" alt="Code"><p><span>ENTER CODE:</span><br><?php echo $user['ref_code']; ?></p></a></li>
                        </ul>
                    </div>
                </div>
            </div>
