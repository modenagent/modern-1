        ...
        <div class="tab-content">
            <div class="tab-pane fade in active row content" id="buyer_content">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-9">
                        <iframe id="buyer_iframe" src="<?php echo base_url().'user/preview/seller/english/9' ?>" style="width: 100%; height:1500px;"></iframe> 
                    </div>
                </div>
            </div>
            <div id="seller_content" class="row content tab-pane fade">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-9">
                        <iframe id="seller_iframe" src="<?php echo base_url().'user/preview/seller/english/9' ?>" style="width: 100%; height:1500px;"></iframe> 
                    </div>
                </div>
            </div>
        </div>
        ...
        success: function (resp) {
            ...
            $.each(controls, function( index, value ) {
                ...
                if ($.trim(value.type) == 'number') {
                    form_content += '<div class="form-group"><label for="'+keyId+'">'+label+'</label><input value="'+value.value+'" maxlength="'+value.limit+'" type="text" class="form-control numeric" id="'+keyId+'" name="'+keyId+'" placeholder="'+label+'"></div>';
                } else if ($.trim(value.type) == 'text') {
                    form_content += '<div class="form-group"><label for="'+keyId+'">'+label+'</label><input value="'+value.value+'" maxlength="'+value.limit+'" type="text" class="form-control" id="'+keyId+'" name="'+keyId+'" placeholder="'+label+'"></div>';
                } else {
                    form_content += '<div class="form-group"><label for="'+keyId+'">'+label+'</label><textarea maxlength="'+value.limit+'" class="form-control" id="'+keyId+'" name="'+keyId+'" rows="3" placeholder="'+label+'">'+value.value+'</textarea></div>';
                }
            });
