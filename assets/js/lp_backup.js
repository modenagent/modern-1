...
$(document).ready(function() {
    ...
    var isNewSearch=false;
        setTimeout(function() {
            jQuery(".loaders").animate({
                opacity: "0"
            });
        }, 1000);
        setTimeout(function() {
            jQuery(".loader-back").animate({
                opacity: "1"
            });
        }, 1000);
...
function data(address, locale) {
    ...
    dataObj.ClientReference = '<CustCompFilter><SQFT>0.20</SQFT><Radius>2.00</Radius></CustCompFilter>';
    dataObj.OwnerName = '';
...
function get187() {
    ...
    $.ajax({
        type: "GET",
        // url: "lp/xmlproxy.php",
        url: base_url+'index.php?/lp/getReportResults?',
        data: {
...
function multipleResults(response) {
    ...
    $(response).find('Locations').children('Location').each(function(i) {
        ...
        $('.search-result table > tbody').append('<tr><td><span class="result-apn"></span></td><td><span class="result-address"></span></td><td><span class="result-city"></span></td><td><a href="javascript:;" class="btn btn-sm btn-default" onclick="apnData(this)">Create Report</a></td></tr>');
