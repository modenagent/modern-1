...
class ReportContentSeeder extends AbstractSeed
{
    /**
     * Run Method.
     *
    ...
    public function run()
    {
        $data = [
            [
                ...
                'page_path'    => 'reports/english/seller/previews/12',
            ...
            [
                ...
                'page_path'    => 'reports/english/seller/previews/13',
            ...
            [
                ...
                'page_path'    => 'reports/english/seller/previews/13',
                'data'    => '{"title":{"value":"Digital Marketing Plan","limit":50,"type":"text"},"sub_title":{"value":"Our Marketing Strategy","limit":85,"type":"text"},"content":{"value":"Other agents may have a digital strategy of posting your house on social media and then rel on other agents to expose your house to buyers. I have an entire digital marketing strategy where I will:\n\n1) ADVERTISE your property, via paid ads on Facebook, Instagram, Google and all real estate sites (think zillow, realtor.com, etc.)\n\n2) Cultivate lists of people who have shown interest in a home like yours, where they work, where they live currently and more to run personalized ads on online platforms.","limit":700,"type":"textarea"},"paragraph_1_title":{"value":"5 Stage Listing Rockets","limit":50,"type":"text"},"paragraph_1_content":{"value":"Secure marketing prowess to help you get more listings; get help digitally marketing via email and social media your listing to more buyers, and get help showing your sellers the impressive results to keep them engaged and making referrals.\n\n•Help you win listings by generating beautifully designed marketing reports for you to bring to your listing presentation.\n\n• We will help market your listings via email blasts to buyers who have shown interest in homes like your listing\n\n• Social media and video ads upon your request","limit":150,"type":"textarea"},"paragraph_2_title":{"value":"5 Stage Video Listing Rockets","limit":50,"type":"text"},"paragraph_2_content":{"value":"Secure marketing prowess to help you get more listings; get help marketing via video on social media.\n\n• Help you win listings by generating beautifully designed marketing reports for you to bring to your listing presentation.\n\n• We will help market your listings via email blasts to buyers who have shown interest in homes like your listing\n\n• Social media and video ads upon your request","limit":150,"type":"textarea"}}',
                'created_at' => date('Y-m-d H:i:s'),
            ],
            [
                'user_id'=>0,
                ...
                'page_path'    => 'reports/english/seller/previews/15',
                'data'    => '{"title":{"value":"Social Proof","limit":50,"type":"text"},"sub_title":{"value":"We Have the Technology and the Numbers","limit":85,"type":"text"},"content":{"value":"We are able to connect instantly with a worldwide audience, with no worry of timezone or language barriers. It is estimated that there are arouund 3.48 billion people using social networks across the world in 2019. We digitally market international, using social media to reach a list of countries that grows every day.","limit":700,"type":"textarea"},"paragraph_1_title":{"value":"@hometownerealestate","limit":50,"type":"text"},"paragraph_1_content":{"value":"• 7,000+ Fans\n\n• 568,000 Link Clicks a Month\n\n• 212,000 Impressions Per Month\n\n• 323 Engaged Users Daily\n\n• 24 Post Interactions Per Day","limit":150,"type":"textarea"},"paragraph_2_title":{"value":"@hometownerealestate","limit":50,"type":"text"},"paragraph_2_content":{"value":"• 8,000+ Followers\n\n• 2,400 Impressions Per Month\n\n• 31% Engagement Rate\n\n• 13 Post Interactions Per Day\n\n• Global Reach","limit":150,"type":"textarea"},"paragraph_3_title":{"value":"Online","limit":50,"type":"text"},"paragraph_3_content":{"value":"•30,000 Searching Buyers\n\n• 7,193 Unique Quarterly Website Visitors\n\n• 3,400 Page Views a Month","limit":150,"type":"textarea"}}',
                'created_at' => date('Y-m-d H:i:s'),
            ],
            [
                'user_id'=>0,
                ...
                'page_path'    => 'reports/english/seller/previews/16',
            ...
            [
                ...
                'page_no'    => '17',
                'page_title'    => 'The Sellers Roadmap',
                'page_path'    => 'reports/english/seller/previews/17',
            ...
            [
                ...
                'page_path'    => 'reports/english/seller/previews/18',
            ...
            [
                ...
                'page_path'    => 'reports/english/seller/previews/19',
        ...
        $posts = $this->table('lp_user_report_content');
        $posts->insert($data)
              ->save();
    }
}
