...
//        css_link.appendTo('head'); 
        ...
        var custom_css = "<style>#cma-widget-container {background: url("+base_url+"/assets/images-2/home/->ReplaceImage<-) no-repeat 0 0;background-attachment: scroll; background-color:; background-size: auto auto;background-size: cover;background-attachment: fixed;} #mainTabMenu li a {background:none; border:none; color:#ffffff;} a{color:#ffffff;} .nav-tabs{ border:none;} </style>";
